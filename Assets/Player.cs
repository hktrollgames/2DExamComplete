...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 대각선이동은 할 수 없다.
        // 문제2 (15점) :  마지막에 누른 방향키 방향으로 이동시키시오
        var move = Move();


        // 문제3) (15점) : 캐릭터가 움직일때 카메라가 따라가는 로직을 구현하시오.
        // 로직으로 구현해야함. 플레이어의 차일드로 설정하거나 시네머신 사용금지
        // 부드럽게 이동할경우 만점
        MoveCamera();

        // 문제4) (20점) : Space키로 공격을 구현하시오(화살(Arrow)을 생성)
        //  (화살은 플레이어가 바라보는 방향으로 날아가야 합니다)
        // 문제5) (15점) : 화살 공격시 공격 애니메이션 재생하시오.
        FireArrow();
